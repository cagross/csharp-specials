...
app.MapGet("/", async context =>
{
  ...
  if (response.IsSuccessStatusCode)
  {
    ...
    string myValue = myResponse.version;
    System.Diagnostics.Debug.WriteLine($"myProp value: {myValue}");
    await context.Response.WriteAsync($"Future port of Grocery Specials web app to .NET based tech stack. See https://github.com/cagross/csharp-specials. See working Swagger page at https://specialscapi20230823213803.azurewebsites.net/swagger/index.html  Here is some sample text: {myValue}");
  }
  else
  {
...
{
  public string version { get; set; } // Replace 'string' with the actual data type of myProp in your JSON
}